            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-gray-100">
                        <h2 className="text-lg font-bold text-gray-900">เชิญสมาชิกใหม่</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-5">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all"
                            />
                            {isSearching && (
                                        ...
                                        {results.map((student) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {isInvited ? (
                                                        <span className="flex items-center gap-1 px-3 py-1.5 bg-emerald-100 text-emerald-700 text-xs rounded-lg">
