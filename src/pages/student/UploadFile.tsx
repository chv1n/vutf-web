      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
           <div className="flex items-center gap-4">
             <span className="font-bold text-gray-900 text-lg">รหัสโครงงาน: 010000</span>
             <span className="h-6 w-px bg-gray-300 hidden md:block"></span>
             <span className="font-medium text-gray-700 text-base md:text-lg">Venue and building reservation system</span>
           </div>
           {/* (Optional) Add Status or other info here */}
        </div>

        {/* --- ส่วนที่ 2: Main Upload Area (กรอบกลาง) --- */}
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 min-h-[400px] flex flex-col justify-center">
