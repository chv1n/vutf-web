    ...
    <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8 min-h-screen">
      ...
      {groups.length === 0 ? (
        ...
        <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-gray-300">
          ...
          <h3 className="text-lg font-bold text-gray-900">ยังไม่มีข้อมูลกลุ่มที่ปรึกษา</h3>
        ...
        <>
          ...
          <section className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-4 md:space-y-0 md:flex md:items-center md:justify-between animate-enter-up"
            ...
            <div className="relative w-full md:w-1/2 lg:w-1/3">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all"
                value={searchTerm}
          ...
          >
            ...
            {paginatedGroups.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                <div className="bg-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 shadow-sm">
                  <FiSlash className="text-gray-400" size={20} />
                </div>
                <p className="text-gray-500 font-medium">ไม่พบข้อมูลตามเงื่อนไขที่ค้นหา</p>
                <button
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <span className="text-sm font-medium text-gray-600 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
          ...
          <section id="detail-section" className="transition-all duration-500 ease-in-out">
            {selectedGroup ? (
              ...
              filteredGroups.length > 0 && (
                <div className="mt-8 p-12 text-center bg-gray-50 rounded-2xl border border-gray-100 text-gray-400">
