            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-gray-100">
                        <h2 className="text-lg font-bold text-gray-900">เพิ่มอาจารย์ที่ปรึกษา</h2>
                    ...
                    <div className="p-5 pb-0">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium border ${selectedRole === AdvisorRole.MAIN ? 'bg-purple-50 border-purple-200 text-purple-700' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'}`}
                            >
                                ที่ปรึกษาหลัก
                            </button>
                            <button
                                onClick={() => setSelectedRole(AdvisorRole.CO)}
                                className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium border ${selectedRole === AdvisorRole.CO ? 'bg-purple-50 border-purple-200 text-purple-700' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'}`}
                            >
                                ที่ปรึกษาร่วม
                            </button>
                        </div>
                    ...
                    <div className="p-5">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="text-black w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none"
                            />
                    ...
                    <div className="max-h-80 overflow-y-auto border-t border-gray-100">
                        ...
                        {query.length < 2 && (
                            <div className="p-8 text-center text-gray-400 text-sm">พิมพ์อย่างน้อย 2 ตัวอักษร</div>
                        )}
                    </div>
                </motion.div>
            </div>
