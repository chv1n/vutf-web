            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                        <span>หน้าหลัก</span>
                        <span>/</span>
                        <span className="text-blue-600 font-medium">คำเชิญ</span>
                    </div>

                    {/* Title */}
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center shadow-xl shadow-amber-200">
                ...
                <motion.div
                    ...
                    className="mb-6"
                >
                    <div className="flex items-center gap-2 p-1.5 bg-gray-100 rounded-xl overflow-x-auto">
                ...
                `}
                  ...
                  ${filter === btn.key ? 'bg-gray-100' : 'bg-gray-200/50'}
                `}>
