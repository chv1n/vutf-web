            ...
            <div className="relative mb-4" ref={dropdownRef}>
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white hover:border-gray-300"
                    />
                    {isLoading && (
            ...
            <div className="space-y-2">
                ...
                {selectedMembers.length === 0 && (
                    <div className="py-8 text-center border-2 border-dashed border-gray-200 rounded-xl">
                        ...
                        <p className="text-xs text-gray-400 mt-1">ค้นหาและเพิ่มสมาชิกด้านบน</p>
                    </div>
                )}
            </div>
        </section>
