...
export const SubmissionFilters: React.FC<Props> = ({ filters, onChange }) => {
    ...
    const FilterSelect = ({
        ...
        <div className="relative group w-full">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors pointer-events-none">
                <Icon />
            </div>
            <select
                className="w-full pl-10 pr-8 py-2.5 bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg 
                   focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:bg-white outline-none 
                   appearance-none transition-all cursor-pointer hover:border-blue-300 truncate"
                value={value || ''}
        ...
        <div className="flex flex-col gap-6 mb-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
                {statusTabs.map((tab) => {
                    ...
                    ${isActive
                                    ? 'bg-blue-600 text-white border-transparent shadow-md shadow-blue-200 translate-y-[-1px]'
                                    : 'bg-white text-gray-600 border-gray-200 hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50'
                                }
                `}
                        >
                            <Icon size={16} className={isActive ? 'text-blue-100' : 'text-gray-400'} />
                            {tab.label}
                        </button>
                    );
                })}
            ...
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col lg:flex-row gap-5 items-start lg:items-center justify-between transition-all hover:shadow-md">
                ...
                <div className="w-full lg:w-[300px] xl:w-[400px]">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-700
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto items-stretch flex-1 justify-end flex-wrap xl:flex-nowrap">
                    ...
                    <div className="lg:hidden flex items-center gap-2 mb-1 w-full">
                        ...
                        <span className="text-sm font-semibold text-gray-700">ตัวกรองข้อมูล</span>
                    </div>
                    ...
                    <button
                        ...
                        className="px-4 py-2.5 bg-gray-50 text-gray-500 border border-gray-200 rounded-lg hover:bg-red-50 hover:text-red-500 hover:border-red-200 transition-all flex items-center justify-center gap-2 group shrink-0"
